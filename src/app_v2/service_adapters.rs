...
use crate::app_v2::ports::{OAuthService, PushService, SupportersService};
use crate::error::AppResult;
use crate::eventsub_v2::infra::client::TwitchApiClientTrait;
use crate::push::PushSubscription;
use crate::push_v2::domain::PushSubscriptionRepository;
use crate::push_v2::infra::SqlitePushSubscriptionRepository;
use crate::supporters_v2::domain::SupporterRepository;
use crate::supporters_v2::infra::SqliteSupporterRepository;
...
impl PushService for SqlitePushService {
    async fn subscribe(
        ...
        self.repo.insert_subscription(endpoint, p256dh, auth, user_id).await
    }
