...
use crate::eventsub_v2::domain::{ChatHandler, StreamLifecycle};
use crate::eventsub_v2::infra::client::TwitchApiClient;
...
impl EventSubManager {
    ...
    pub async fn start(&self) -> AppResult<()> {
        ...
        let handle = tokio::spawn(async move {
            ...
            crate::eventsub_v2::infra::listener::start_eventsub_task(api_client, lifecycle, shutdown_rx).await;
        });
